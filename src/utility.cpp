...
namespace StaticDB {
    ...
    vector<string> Split(const string& str,const string& sep)
    {
        ...
        bool bp2 = sep.find("]") != string::npos || sep.find("}") != string::npos || sep.find(")") != string::npos || bp1;
    ...
    const string& get_StartMsg(void )
    {
        ...
        if(!StrMSG.length()) StrMSG = StrMSG +"Static Database v"+ get_version() + "[This is a prototype]\nCopyright Under GNU Public License 3.\n\n";
        return StrMSG;
    }
